...
], NoteModel.prototype, "noteName", void 0);
__decorate([
    sequelize_typescript_1.AllowNull(false),
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.STRING }),
    __metadata("design:type", String)
...
], NoteModel.prototype, "noteBooks", void 0);
NoteModel = __decorate([
    sequelize_typescript_1.Table({ tableName: 'note', modelName: 'NoteModel', timestamps: true })
], NoteModel);
